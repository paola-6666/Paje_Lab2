    ...
    return (
        <div className="event-planner-container">
            ...
            <section className='description'>
                <p>Plan and organize your events effortlessly with Event Planner. From birthdays to corporate meetings, we got you covered!</p>
            ...
            <section className='events_categories'>
                ...
                <ul>
                    ...
                    <li>Neighboorhood Block Parties</li>
